...
public class ActivityLoaderActivity extends Activity {
	...
	private void startExplicitActivation() {
		...
		Intent explicitLoadedIntent = new Intent(ActivityLoaderActivity.this, ExplicitlyLoadedActivity.class);
				
		// TODO - Start an Activity using that intent and the request code defined above
		startActivityForResult(explicitLoadedIntent, GET_TEXT_REQUEST_CODE);
	}
	...
	private void startImplicitActivation() {
		...
		Intent urlImplicitIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(URL));
		
		// TODO - Create a chooser intent, for choosing which Activity
		// will carry out the baseIntent. Store the Intent in the 
		// chooserIntent variable below. HINT: using the Intent class' createChooser())
		Intent chooserIntent = Intent.createChooser(urlImplicitIntent, CHOOSER_TEXT);
